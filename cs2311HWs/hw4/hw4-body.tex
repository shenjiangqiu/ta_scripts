...
\headrule \header{\textbf{cs2311 - Fall 2017}}{\textbf{HW
 4  \ifprintanswers - Solutions \fi}}{\textbf{Due: Fri. 10/06/17}} \footrule \footer{}{Page \thepage\
of \numpages}{}
...
\gquestion{8}{2}{e} Rosen Ch 9.5 \# 2(a,c-e) p. 615
    \ifprintanswers
        \vspace{-15pt}
    \fi
    \begin{EnvFullwidth}
...
\end{enumerate}
	...
	\ifprintanswers
        \vspace{-10pt}
    \fi
\gquestion{3}{2}{(a,b)} Rosen Ch 9.5 \# 24, p. 616.  \\
If it is an equivalence relation, list the equivalence classes assuming the elements are ordered $x_1, x_2, x_3, x_4, \dots$. 
    ...
    \ifprintanswers
        \vspace{-10pt}
    \fi
\ugquestion{3} Rosen Ch 9.5 \# 56(a,b), p.617
    \ifprintanswers
        \vspace{-15pt}
    \fi
    \begin{solution}
    ...
    \ifprintanswers
        \vspace{-10pt}
    \fi
\gquestion{2}{2}{all} Rosen Ch 9.6 \#4(a,c), p. 630.
    \ifprintanswers
        \vspace{-15pt}
    \fi
    \begin{solution}
...
\fi
    ...
    \ifprintanswers
        \vspace{-10pt}
    \fi
\ugquestion{6} Rosen Ch 9.6 \#32(a-f), p. 631.
    \ifprintanswers
        \vspace{-15pt}
    \fi
    \begin{solution}
