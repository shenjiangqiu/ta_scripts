...
2 - Solutions}}{\textbf{Due: Thurs. 1/27/11}} \footrule \footer{}{Page \thepage\
of \numpages}{}
...
\end{itemize}
    \begin{solution}
    \begin{my_parts}
        \part Everyone in your class has a cell phone
        $$ \forall x\; P(x) \hspace{2in} \forall x\; (C(x) \rightarrow P(x))$$
        \part Somebody in your class has seen a foreign movie.
        $$ \exists x\; M(x) \hspace{2in} \exists x\; (C(x) \wedge M(x))$$
...
\question[6] Rosen Ch 1.4, \#10(a,d,i), p. 59
    \begin{solution}
    \begin{my_item}
