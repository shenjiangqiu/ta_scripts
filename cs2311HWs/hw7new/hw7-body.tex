...
\ugquestion{2} Rosen Ch 1.4 \#8(a,d)  p. 53 
    \ifprintanswers
        \vspace{-12pt}
    \fi
  \begin{solution}
...
\gquestion{3}{2}{c-d}\label{probA} Rosen Ch 1.4 \#28(c, d, e), p. 54 \\
...
\ugquestion{3} Rosen Ch 1.4 \# 38(d,e), p. 55
    \ifprintanswers
        \vspace{-12pt}
    \fi
  \begin{solution}
...
\gquestion{3}{1}{b} Rosen Ch 1.4 \#42(a-c), p. 55\\
Use the following predicates:
  \begin{itemize}[itemsep=0pt,parsep=0pt,topsep=0pt,partopsep=0pt]
...
\ugquestion{2} Rosen Ch 1.5 \#4(a,c), p. 64
    \ifprintanswers
        \vspace{-12pt}
    \fi
  \begin{solution}
...
\gquestion{8}{8}{all} Rosen Ch 1.6 \#14 (d), p. 79 \\
...
\ugquestion{2} Rosen Ch 1.6 \# 16(c,d), p. 79
    \ifprintanswers
        \vspace{-15pt}
    \fi
\begin{solution}
...
\ugquestion{2} Rosen Ch 1.6 \# 18, p. 79
    \ifprintanswers
        \vspace{-10pt}
    \fi
\begin{solution}
